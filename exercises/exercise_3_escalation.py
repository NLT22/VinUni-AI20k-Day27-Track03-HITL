    ...
    with console.status("[dim]LLM reviewing the diff...[/dim]"):
        analysis = llm.invoke([
            {"role": "system", "content": (
                ...
                "Reference the relevant file, symbol, or changed behavior from the diff."
            )},
        ...
        refined = llm.invoke([
            {
                "role": "system",
                "content": (
                    "You are a senior reviewer refining a PR review after human escalation. "
                    "Use the reviewer answers as authoritative context. Return a complete "
                    "PRAnalysis suitable for posting as the final review."
                ),
            },
            {
                "role": "user",
