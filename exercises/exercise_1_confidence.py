        ...
        analysis = llm.invoke([
            {
                ...
                "content": (
                    ...
                    "Return a structured PRAnalysis with a concise summary, concrete "
                    "risk factors, actionable comments, a calibrated confidence score, "
                    "and escalation questions only when needed."
                ),
            },
            {
                "role": "user",
                "content": (
                    ...
                    f"Changed files: {', '.join(state['pr_files'])}\n\n"
                    f"Unified diff:\n{state['pr_diff']}"
                ),
            },
        ])
